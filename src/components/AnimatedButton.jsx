...
const AnimatedButton = ({
  ...
  const getButtonStyles = () => {
    ...
    switch (variant) {
      case 'primary':
        return `${baseStyles} bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:from-purple-700 hover:to-indigo-700 shadow-md hover:shadow-lg`
      case 'secondary':
        return `${baseStyles} bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700 shadow-md hover:shadow-lg`
      case 'outline':
        return `${baseStyles} border border-purple-600 text-purple-600 hover:bg-purple-50`
      case 'ghost':
        return `${baseStyles} text-purple-600 hover:bg-purple-50`
      case 'danger':
