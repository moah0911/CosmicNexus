    ...
    <>
      ...
      >
        <div className="p-6">
          <div className="flex items-center justify-center mb-4">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-700 to-indigo-700 flex items-center justify-center relative overflow-hidden"
              style={{ boxShadow: '0 0 15px rgba(147, 51, 234, 0.3)' }}>
              <i className="bi bi-stars text-purple-200 text-2xl relative z-10"></i>
          ...
          <h3 className="text-xl font-bold text-center mb-4 bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-indigo-300">Edit Your Cosmic Discovery</h3>
          ...
          <div className="flex justify-center space-x-4 mt-6">
            <button
              ...
              className="px-6 py-3 rounded-xl border border-purple-600/50 text-purple-300 hover:bg-purple-900/30 transition-all duration-300 min-w-[120px]"
            >
              <i className="bi bi-x-circle mr-2"></i> Cancel
            </button>
            <button
              onClick={handleEdit}
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white shadow-md hover:shadow-lg transition-all duration-300 hover:from-purple-500 hover:to-indigo-500 min-w-[120px]"
      ...
      >
        <div className="p-6">
          ...
          <div className="bg-black/60 p-4 rounded-xl shadow-sm border border-indigo-800/30 mb-6 max-h-[150px] overflow-y-auto">
            <p className="text-indigo-300 font-serif italic leading-relaxed text-sm">"{prompt.content}"</p>
          </div>
          ...
          <div className="flex justify-center space-x-4 mt-6">
            ...
            >
              <i className="bi bi-arrow-left mr-2"></i> Keep
            </button>
            <button
